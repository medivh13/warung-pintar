...
import (
	...
	"warung-pintar/item-service/src/interface/rest/handlers"

	"warung-pintar/item-service/src/interface/rest/response"
	"warung-pintar/item-service/src/interface/rest/route"
...
func makeRoute(
	...
	ih := itemHandler.NewItemHandler(respClient, useCases.ItemUseCase)

	r.Route("/api", func(r chi.Router) {
		// health check
		r.Mount("/", route.HealthRouter(hh))
		r.Mount("/items", route.ItemAppRouter(ih))
