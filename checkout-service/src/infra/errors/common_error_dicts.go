...
var errorCodes = map[ErrorCode]*CommonError{
	...
	FAILED_RETRIEVE_STATUS_PAGE: {
		ClientMessage: "Failed to retrieve Status Page Address Or Produce Mail.",
		SystemMessage: "Something wrong happened while retrieve Status Page Addres Or Produce Mail.",
		ErrorCode:     FAILED_RETRIEVE_ORDER,
	},
